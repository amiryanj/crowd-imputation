...
from crowdrep_bot.crowd_imputation.pcf_crowd_synthesis import PCFCrowdSynthesizer
from crowdrep_bot.crowd_tracking.dr_spaam_detector import DrSpaamDetector
from crowdrep_bot.crowd_imputation.crowd_communities import CommunityHandler, CommunityDetector
from crowdrep_bot.crowd_imputation.social_ties import SocialTiePDF
from crowdrep_bot.crowd_tracking.human_detection import PedestrianDetection
from crowdrep_bot.robot_sim.robot import MyRobot
from crowdrep_bot.robot_sim.robot_replace_human import RobotReplaceHuman
...
from crowdrep_bot.util.csv_logger import CsvLogger
from crowdrep_bot.util.eval import Evaluation
from crowdrep_bot.util.mapped_array import MappedArray
from crowdrep_bot.util.video_player import DatasetVideoPlayer
from crowdrep_bot.util.transform import Transform
from crowdrep_bot.util.read_lidar_data import read_lidar_data
from crowdrep_bot.gui.visualizer import *

from crowdrep_bot.__config__ import *
...
def exec_scenario(scenario):
    ...
    # =======================================
    # output_dir = "/home/cyrus/workspace2/ros-catkin/src/crowdrep_bot/src/crowdrep_bot/temp/robot_obsvs"
...
if __name__ == '__main__':
    ...
    pcf_crowd_rec = PCFCrowdSynthesizer()
