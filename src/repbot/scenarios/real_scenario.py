...
from repbot.gui.visualizer import BLUE_COLOR
from repbot.gui.visualizer import Visualizer
    ...
    def step(self, dt, lidar_enabled, save=False):
        ...
        if not self.world.pause and not_finished:
            ...
            if save:
                ...
                self.visualizer.save_screenshot(os.path.join(home, 'Videos/repbot/scene'), self.world.original_frame_id)
        self.update_display()
        return not_finished
