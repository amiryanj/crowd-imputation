...
from followbot.util.carla_settings import static_scenes
from toolkit.loaders.loader_hermes import load_bottleneck
from followbot.util.carla_utils import Camera, get_bp
...
if __name__ == "__main__":
    ...
    parser.add_argument("end_frame_idx", type=int,
                        help="inclusive")
    parser.add_argument("--robot_id", type=int, default=6,  # robot_id_ = -1  # to disable robot
